...
fun NewGameListScreen(
    ...
    Column(
        ...
        Toolbar(
            viewState = ToolbarViewState(title = "Configurar lista"),
            navController = navController,
...
private fun ContentView(
    ...
    NewGameListView(
        ...
        onMaxPlayersSet = {
            viewModel.onMaxPlayersSet(it.toInt())
        },
    ...
    Column(
        ...
        FormField(
            viewState = FormFieldViewState(
                ...
                input = state.maxPlayers.toString(),
            ),
...
private fun ConfigureListButton(
    ...
    val viewState = if (isLoading) {
        ...
        ButtonViewState.Content(
            text = if (isNewList) "Abrir lista" else "Atualizar lista",
            isEnabled = isEnabled,
        )
    }
