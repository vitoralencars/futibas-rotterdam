...
import gamelist.presentation.viewmodel.CurrentGameListViewModel
import gamelist.presentation.viewmodel.GameListViewModel
import gamelist.presentation.viewmodel.HistoryListsViewModel
...
val gameListModule = module {
    ...
    viewModelOf(::CurrentGameListViewModel)
    viewModelOf(::HistoryListsViewModel)
}
